...
//go:generate mockgen -source offset_store.go -destination mock_offset_store.go -self_package github.com/yj2280/rocketmq-admin/consumer  --package consumer OffsetStore
