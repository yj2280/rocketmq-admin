...
//go:generate mockgen -source offset_store.go -destination mock_offset_store.go -self_package github.com/slh92/rocketmq-admin/consumer  --package consumer OffsetStore
